...
String.prototype.toSimpleChinese = function () {

    var k = '';
    for (var i = 0; i < this.length; i++)
        k += (t.indexOf(this.charAt(i)) == -1) ? this.charAt(i) : s.charAt(t.indexOf(this.charAt(i)))
    return k;
}

function toChinese() {
    document.body.innerHTML = document.body.innerHTML.toChinese();
}

function toSimpleChinese() {
    document.body.innerHTML = document.body.innerHTML.toSimpleChinese();
}
