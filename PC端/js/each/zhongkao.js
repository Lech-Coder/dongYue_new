...
//颜色
const pie_colors = ['#8BC34A', '#EAED42', '#ED8A42']

for (let i=0;i<$(".color_1").length;i++){
    $(".color_1")[i].style.backgroundColor=pie_colors[0]
}
for (let i=0;i<$(".color_3").length;i++){
    $(".color_3")[i].style.backgroundColor=pie_colors[1]
}

for (let i=0;i<$(".color_4").length;i++){
    $(".color_4")[i].style.backgroundColor=pie_colors[2]
}
